...
// let floorTexture = new THREE.ImageUtils.loadTexture('Images/Floor 2.jpg');
let floorTexture = new THREE.TextureLoader().load('Images/Floor 2.jpg')
// textureLoader.load("images/Floor 2.jpg")

//create floor plane.
let planeGeometry = new THREE.PlaneBufferGeometry(50, 50); //box geometery is the shape of the object
